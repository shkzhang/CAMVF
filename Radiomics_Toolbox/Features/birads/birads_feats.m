...
[xshape,fshape] = shape_feats(BW);      % Shape,16
[xorie,forie] = orient_feats(BW);       % Orientation,2
[xmarg,fmarg] = margin_feats(BW);       % Margin,3
[xboun,fboun] = bound_feats(I,BW);      % Boundary,5
[xecho,fecho] = echo_feats(I,BW);       % Echo pattern,181->4
[xpab,fpab] = pab(I,BW);                % Posterior behavior,2
disp(length(xpab));
% Features
